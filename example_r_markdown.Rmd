...
That top part with blue `---` is the YAML part of a .rmd document. It tells it how to be rendered.

**This** text is markdown. It is a basic way to write text and do *simple* styling.

The part below is a code chunk. Write R there and run with CMD/Ctrl + SHIFT + ENTER.
